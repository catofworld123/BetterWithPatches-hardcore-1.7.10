...
public class RenderCampfire implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
        ...
        if (world.getBlockMetadata(x, y, z) >= 6){
            ...
            renderer.renderStandardBlock(block, x, y, z);
            renderer.setRenderBounds(0.90625, 0,0.46875 ,0.96875, 0.6875, 0.53125);
            renderer.renderStandardBlock(block, x, y, z);
            renderer.setRenderBounds(0.03125, 0.625,0.40625 ,0.09375, 0.84375, 0.46875);
            renderer.renderStandardBlock(block, x, y, z);
            renderer.setRenderBounds(0.90625, 0.625,0.40625 ,0.96875, 0.84375, 0.46875);
            renderer.renderStandardBlock(block, x, y, z);
            renderer.setRenderBounds(0.03125, 0.625,0.53125 ,0.09375, 0.84375, 0.59375);
            renderer.renderStandardBlock(block, x, y, z);
            renderer.setRenderBounds(0.90625, 0.625,0.53125 ,0.96875, 0.84375, 0.59375);
            renderer.renderStandardBlock(block, x, y, z);
            renderer.clearOverrideBlockTexture();
            renderer.setOverrideBlockTexture(((Campfire) BWPRegistry.campfire).icons[3]);
        ...
        if (world.getBlockMetadata(x, y, z) == 4) {
            ...
            double dScale = fireAnimationScaleArray[3];
